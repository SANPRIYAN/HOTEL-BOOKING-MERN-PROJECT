...
const styles = {
  container: {
    ...
    backgroundColor: '#17252A', // updated dark background
  },
  header: {
    backgroundColor: '#2B7A78', // primary teal
    padding: '10px',
    color: '#FEFFFF',
    textAlign: 'center',
    position: 'relative',
  ...
  form: {
    ...
    maxHeight: '400px',
    overflowY: 'auto',
    backgroundColor: '#DEF2F1', // light background for card/form
    padding: '20px',
    borderRadius: '10px',
